...
public sealed partial class NPCCombatSystem
{
    ...
    // private const float ShootSpeed = 20f; VXS
    ...
    private void UpdateRanged(float frameTime)
    {
        ...
        while (query.MoveNext(out var uid, out var comp, out var xform))
        {
            ...
            // var worldPos = _transform.GetWorldPosition(xform); VXS
            // var targetPos = _transform.GetWorldPosition(targetXform); VXS
            ...
            // var distance = (targetPos - worldPos).Length(); VXS
            // var oldInLos = comp.TargetInLOS; VXS
            ...
            if (comp.LOSAccumulator < 0f)
            {
                ...
                // var collisionGroup = comp.UseOpaqueForLOSChecks ? CollisionGroup.Opaque : (CollisionGroup.Impassable | CollisionGroup.InteractImpassable); VXS
                // comp.TargetInLOS = _interaction.InRangeUnobstructed(uid, comp.Target, distance + 0.1f, collisionGroup); VXS
            ...
            // var mapVelocity = targetBody.LinearVelocity; VXS
            // var targetSpot = targetPos + mapVelocity * distance / ShootSpeed; VXS

            // If we have a max rotation speed then do that.
            // var goalRotation = (targetSpot - worldPos).ToWorldAngle(); VXS
            ...
            if (_mapManager.TryFindGridAt(xform.MapID, xt, out var gridUid, out var mapGrid)) // VXS: targetPos -> xt
            {
